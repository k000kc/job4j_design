...
class SimpleCollectionTest {
    ...
    void checkNavigationList() {
        ...
        /*элемент по индексу*/
        assertThat(simpleCollection).element(3).isNotNull()
                .isEqualTo(4);
        /*последний элемент*/
    ...
    void checkFilteredList() {
        SimpleCollection<Integer> simpleCollection = new SimpleCollection<>(1, 2, 3, 4, 5);
        /*фильтруем источник по предикату и работаем с результатом фильтрации*/
        assertThat(simpleCollection).filteredOn(e -> e > 1).first().isEqualTo(2);
